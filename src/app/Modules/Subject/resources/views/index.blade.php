            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('subjects.create') }}" class="btn btn-primary btn-sm ms-auto">Create Subject</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="{{ $loop->even ? 'even' : 'odd' }}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        class="btn btn-danger btn-sm subject-delete">Delete</a>
...
<script>
   document.querySelectorAll('.subject-delete').forEach(function (element) {
